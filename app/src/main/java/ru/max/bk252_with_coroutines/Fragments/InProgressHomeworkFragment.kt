...
import ru.max.bk252_with_coroutines.Fragment_Adapters.InProgressHomeworkAdapter
import ru.max.bk252_with_coroutines.Fragment_Adapters.InProgressItemClickListener
import ru.max.bk252_with_coroutines.R

class InProgressHomeworkFragment   : Fragment(), InProgressItemClickListener {
    ...
    private fun getList(){
        ...
        for (i in 0 until TaskArray.length()) {
            ...
            if (Object.getString("status") == "complite" || Object.getString("status") == "faild")
            {
                continue
            }
            listTasks.add(
    ...
    private fun initView(){
        ...
        val CardAdapter = InProgressHomeworkAdapter(listTasks, this)
