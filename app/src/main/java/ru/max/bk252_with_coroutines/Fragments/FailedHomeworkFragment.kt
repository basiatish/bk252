...
import ru.max.bk252_with_coroutines.Fragment_Adapters.FailedHomeworkAdapter
import ru.max.bk252_with_coroutines.Fragment_Adapters.FailedItemClickListener
import ru.max.bk252_with_coroutines.Fragment_Adapters.ItemClickListener
import ru.max.bk252_with_coroutines.R

class FailedHomeworkFragment  : Fragment(), FailedItemClickListener {
    ...
    private fun getList(){
        ...
        for (i in 0 until TaskArray.length()) {
            ...
            if (Object.getString("status") == "complite")
            {
                continue
            }
            listTasks.add(
    ...
    private fun initView(){
        ...
        val CardAdapter = FailedHomeworkAdapter(listTasks, this)
